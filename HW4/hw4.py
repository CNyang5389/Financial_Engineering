...
if dd=='n':
    ...
    x=float(input('請輸入 strike pirce:'))
...
c=sh+p-x*math.exp(-1*r*j)
print('The value of the Europian put is $', round(p,3))
print('The value of the Europian call is $', round(c,3))
